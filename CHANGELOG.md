...
- MANA is organized as a [`DMTCP`](https://github.com/dmtcp/dmtcp) plugin.  This release has been updated to use DMTCP commit 4ca742e (beyond DMTCP 3.1.2, and close to a future DMTCP 3.2.0 release).
